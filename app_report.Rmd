...
legend(9,max(active_user)*1.5,pt.bg=c("#5B9BD5","#ED7D31"),c("andriod","ios"),pch = 22,pt.cex = 2)
```
<br>
...
lines(cishu_andriod_t,cishu_andriod,type = "b",pch=15,lty=2,col="#5B9BD5",lwd=2,cex=1)
 ...
 axis(side=2,at=seq(0,max(max(cishu_iOS,cishu_andriod))+30,by=100),labels =seq(0,max(max(cishu_iOS,cishu_andriod))+30,by=100),cex.axis=0.85,las=2)
 abline(h=c(seq(0,max(max(cishu_iOS,cishu_andriod))+30,100)),lty=15,lwd=0.1)
```
